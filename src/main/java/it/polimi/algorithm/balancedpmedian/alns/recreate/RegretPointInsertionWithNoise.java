...
public class RegretPointInsertionWithNoise extends RegretPointInsertion {

    private Random random;
    private double maxNoise;

    public RegretPointInsertionWithNoise(BPMProblem problem, Random random, double maxNoise) {
        super(problem);
        this.random = random;
