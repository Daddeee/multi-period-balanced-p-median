...
public class BalancedPMedianRVNS implements Solver {
    ...
    public BalancedPMedianRVNS() {
        this(new Random());
    }

    public BalancedPMedianRVNS(int seed) {
        this(new Random(seed));
    }

    public BalancedPMedianRVNS(Random random) {
        this.random = random;
    }
